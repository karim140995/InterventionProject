...
public class InterventionListeView extends VerticalLayout implements InterventionViewInterface {
	...
	public void init()
	{
				...
				intervention_liste.addContainerProperty("Remarques", String.class,  null);
	...
	public void Add_item( Intervention intervention, Client client)
	{
		   ...
		   intervention_liste.addItem(new Object[] {
				    intervention.getIdintervention(),intervention.getObjet(),intervention.getPayement(),intervention.getPriorité(),intervention.getEtat(),intervention.getDescription(),intervention.getRemarque(),intervention.getDate_ajout(),client.getNom_client(), Actions_view},intervention.getIdintervention());
	...
	public void ShowAddInterventionWindow() {
		...
		AddInterventionWindowPresenter presenter= new AddInterventionWindowPresenter(this);
		AddInterventionWindowView view=new AddInterventionWindowView(presenter);
