...
public class TableActionsView extends VerticalLayout {
	...
	public TableActionsView()
	{
		...
		Resource ModifyIcon= new ThemeResource("img/ok.png");
		...
		btn_supprimer.setDescription("Supprimer");
		btn_modfier.setDescription("Clotuer");
	...
	public void ShowErrorMessage()
	{
		...
		Notification notif = new Notification("Erreur serveur",
	            "",
